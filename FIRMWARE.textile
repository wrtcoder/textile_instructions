...
* Download additional Linaro binaries and configuration from "here":https://wiki.linaro.org/ARM/VersatileExpress?action=AttachFile&do=get&target=vemsd-armlt-20121108-001.zip
** Unzip the firmware zip to the root of the motherboard mounted drive
...
* Set "SW[0]":http://infocenter.arm.com/help/index.jsp?topic=/com.arm.doc.ddi0496a/CACFDBII.html on the rear panel of the board to ON
* Reboot the Versatile Express board
** You will need to configure UEFI to boot the image on the SD card.
** See the "UEFI page":https://wiki.linaro.org/ARM/UEFI#Configure_UEFI on the Linaro Wiki for more details on configuring UEFI.
