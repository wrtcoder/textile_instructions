...
| "HMP: Avoid using the cpu stopper to stop runnable tasks":https://git.linaro.org/gitweb?p=kernel/linux-linaro-stable.git;a=commit;h=2a68d1e9125582bedeac4ea34fb9901ab1f7de11 | <div style="color:white;background-color:green">New in this release</div> |
| "sched: hmp: add read-only hmp domain sysfs file":https://git.linaro.org/gitweb?p=kernel/linux-linaro-stable.git;a=commit;h=0b877c2baac65994016c6812804d1b30e89c18ed | <div style="color:white;background-color:green">New in this release</div> |
| "Documentation: HMP: Small Task Packing explanation":https://git.linaro.org/gitweb?p=kernel/linux-linaro-stable.git;a=commit;h=f5be72980bc321f3491377861835c343cc27af0d | <div style="color:white;background-color:green">New in this release</div> |
| "sched: hmp: Fix build breakage when not using CONFIG_SCHED_HMP":https://git.linaro.org/gitweb?p=kernel/linux-linaro-stable.git;a=commit;h=7cf6a7300bb9a88f543061270419427395ab4d2f | <div style="color:white;background-color:green">New in this release</div> |
