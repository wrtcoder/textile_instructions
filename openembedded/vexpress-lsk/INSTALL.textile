...
bc. wget http://releases.linaro.org/13.12/openembedded/vexpress-lsk/vexpress-openembedded_alip-armv7a-gcc-4.8_${DATE}-${HWPACKNUM}.img.gz.
...
zcat vexpress-openembedded_alip-armv7a-gcc-4.8_${DATE}-${HWPACKNUM}.img.gz | sudo dd bs=64k of=$SDCARD
...
wget http://releases.linaro.org/13.12/openembedded/vexpress-lsk/linaro-image-alip-genericarmv7a-${DATE}-${IMAGENUM}.rootfs.tar.gz
