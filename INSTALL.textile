...
* This release "pre-built image":http://releases.linaro.org/13.09/openembedded/vexpress-lsk/vexpress-openembedded_alip-armv7a-gcc-4.8_20130926-475.img.gz.
...
bc. wget http://releases.linaro.org/13.09/openembedded/vexpress-lsk/hwpack_linaro-lsk-vexpress_20130926-475_armhf_supported.tar.gz
...
bc. sudo linaro-media-create --mmc /dev/sdX --dev vexpress --hwpack hwpack_linaro-lsk-vexpress_20130926-475_armhf_supported.tar.gz --binary linaro-image-alip-genericarmv7a-20130925-103.rootfs.tar.gz
