...
* This release pre-built image (vexpress-raring_developer_20130826-443.img.gz), which you can downloaded from the above list of artifacts or from "here":http://releases.linaro.org/13.09/ubuntu/vexpress/vexpress-raring_developer_20130826-443.img.gz
...
bc. wget http://releases.linaro.org/13.09/ubuntu/vexpress/hwpack_linaro-vexpress_20130826-443_armhf_supported.tar.gz
wget http://releases.linaro.org/13.09/ubuntu/vexpress/linaro-raring-developer-20130826-474.tar.gz
