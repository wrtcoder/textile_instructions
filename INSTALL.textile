...
The root file systems are described "here":http://releases.linaro.org/13.01/ubuntu/precise-images where you can also download them.
...
* This release pre-built image (vexpress-precise_ubuntu-desktop_20121127-445.img.gz), which you can downloaded from the above list of artifacts or from "here":http://releases.linaro.org/13.01/ubuntu/vexpress/vexpress-precise_ubuntu-desktop_20121127-445.img.gz
...
zcat vexpress-precise_ubuntu-desktop_20121127-445.img.gz | sudo dd bs=64k of=$SDCARD
...
*Note:* The instructions above attempt to build an Ubuntu Desktop image. If you wish to create a small image, you can replace the ubuntu desktop tar ball with another root file system, which you can download from "here":http://releases.linaro.org/13.01/ubuntu/precise-images
bc. wget http://releases.linaro.org/13.01/ubuntu/vexpress/hwpack_linaro-vexpress_20121127-445_armhf_supported.tar.gz
wget http://releases.linaro.org/13.01/ubuntu/vexpress/linaro-precise-ubuntu-desktop-20121124-560.tar.gz
...
bc. wget http://releases.linaro.org/13.01/components/platform/linaro-image-tools/linaro-image-tools-2013.01.tar.gz
...
bc. sudo linaro-media-create --mmc /dev/sdX --dev vexpress --hwpack hwpack_linaro-vexpress_20121127-445_armhf_supported.tar.gz --binary linaro-precise-ubuntu-desktop-20121124-560.tar.gz
