...
* This release pre-built image (vexpress-precise_ubuntu-desktop_20121127-445.img.gz), which you can downloaded from the above list of artifacts or from "here":http://releases.linaro.org/12.11/ubuntu/vexpress/vexpress-precise_ubuntu-desktop_20121127-445.img.gz
