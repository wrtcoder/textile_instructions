...
The root file systems are described "here":http://releases.linaro.org/13.03/ubuntu/precise-images where you can also download them.
...
* This release pre-built image (vexpress-quantal_developer_20130324-276.img.gz), which you can downloaded from the above list of artifacts or from "here":http://releases.linaro.org/13.03/ubuntu/vexpress/vexpress-quantal_developer_20130324-276.img.gz
...
*Note:* The instructions above attempt to build an Ubuntu Desktop image. If you wish to create a small image, you can replace the ubuntu desktop tar ball with another root file system, which you can download from "here":http://releases.linaro.org/13.03/ubuntu/precise-images
bc. wget http://releases.linaro.org/13.03/ubuntu/vexpress/hwpack_linaro-vexpress_20130324-276_armhf_supported.tar.gz
wget http://releases.linaro.org/13.03/ubuntu/vexpress/linaro-quantal-developer-20130324-313.tar.gz
...
bc. wget http://releases.linaro.org/13.03/components/platform/linaro-image-tools/linaro-image-tools-2013.03.tar.gz
