...
** Reboot the board
*** When prompted with the “Cmd>" prompt, press the red reboot button
...
Sometimes, you may wish to build your own custom image for a Versatile Express. Perhaps you wish to use a more recent snapshot of the "hardware pack":https://wiki.linaro.org/HardwarePacks for Ubuntu or use a different "root file system":http://releases.linaro.org/12.10/ubuntu/precise-images other than Ubuntu. Whatever the reason, you will want to use the "Linaro media tools":https://wiki.linaro.org/Linaro-Image-Tools to create a custom image.
...
bc. wget http://releases.linaro.org/12.10/ubuntu/vexpress/hwpack_linaro-vexpress_20121021-377_armhf_supported.tar.gz http://releases.linaro.org/12.10/ubuntu/vexpress/linaro-precise-ubuntu-desktop-20121021-492.tar.gz
...
** Insert the SD card into the board
** Reboot the board. When presented with the “Cmd>" prompt, press the red button
