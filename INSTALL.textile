...
* This release pre-built image (vexpress-quantal_developer_20130128-58.img.gz), which you can downloaded from the above list of artifacts or from "here":http://releases.linaro.org/13.01/ubuntu/vexpress/vexpress-quantal_developer_20130128-58.img.gz
...
zcat vexpress-quantal_developer_20130128-58.img.gz | sudo dd bs=64k of=$SDCARD
...
bc. wget http://releases.linaro.org/13.01/ubuntu/vexpress/hwpack_linaro-vexpress_20130128-58_armhf_supported.tar.gz
wget http://releases.linaro.org/13.01/ubuntu/vexpress/linaro-quantal-developer-20130128-256.tar.gz
...
bc. sudo linaro-media-create --mmc /dev/sdX --dev vexpress --hwpack hwpack_linaro-vexpress_20130128-58_armhf_supported.tar.gz --binary linaro-quantal-developer-20130128-256.tar.gz
