...
* This release pre-built image (vexpress-raring_developer_20130625-379.img.gz), which you can downloaded from the above list of artifacts or from "here":http://releases.linaro.org/13.06/ubuntu/vexpress/vexpress-raring_developer_20130625-379.img.gz
...
zcat vexpress-raring_developer_20130625-379.img.gz | sudo dd bs=64k of=$SDCARD
...
wget http://releases.linaro.org/13.06/ubuntu/vexpress/linaro-raring-developer-20130623-410.tar.gz
...
bc. sudo linaro-media-create --mmc /dev/sdX --dev vexpress --hwpack hwpack_linaro-vexpress_20130625-379_armhf_supported.tar.gz --binary linaro-raring-developer-20130623-410.tar.gz
