...
* This release pre-built image (vexpress-precise_ubuntu-desktop_20121021-377.img.gz), which you can downloaded from the above list of artifacts or from "here":http://releases.linaro.org/12.11/ubuntu/vexpress/vexpress-precise_ubuntu-desktop_20121127-445.img.gz
...
bzcat vexpress-precise_ubuntu-desktop_20121021-377.img.gz | sudo dd bs=64k of=$SDCARD
...
*Note:* The instructions above attempt to build an Ubuntu Desktop image. If you wish to create a small image, you can replace the ubuntu desktop tar ball with another root file system, which you can download from "here":http://releases.linaro.org/12.11/ubuntu/precise-images
bc. wget http://releases.linaro.org/12.11/ubuntu/vexpress/hwpack_linaro-vexpress_20121127-445_armhf_supported.tar.gz
wget http://releases.linaro.org/12.11/ubuntu/vexpress/linaro-precise-ubuntu-desktop-20121124-560.tar.gz
