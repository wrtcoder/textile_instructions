...
* This release pre-built image (vexpress-quantal_developer_20130423-299.img.gz), which you can downloaded from the above list of artifacts or from "here":http://releases.linaro.org/13.04/ubuntu/vexpress/vexpress-quantal_developer_20130423-299.img.gz
