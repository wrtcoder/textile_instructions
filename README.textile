...
* "LP: #1122930":https://launchpad.net/bugs/1122930 UEFI: Update Boot Device Entry corrupts config
...
* "LP: #1104084":https://launchpad.net/bugs/1104084 gator doesn't build with CONFIG_MODULE=n
