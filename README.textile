...
Recently a set of patches has been developed that focus on performance and power optimisation. These patches give considerable uplift across a range of benchmarks. Early access to these patches is provided here:

"https://wiki.linaro.org/ARM/VersatileExpress?action=AttachFile&do=get&target=bigLITTLE-MP-13.06-optimization-pack-10072013-02.tar.gz":https://wiki.linaro.org/ARM/VersatileExpress?action=AttachFile&do=get&target=bigLITTLE-MP-13.06-optimization-pack-10072013-02.tar.gz

The patches in the pack apply cleanly on top of this 13.06 release.

These patches will also be included in the next release (13.07).
...
* "ARM-15":http://cards.linaro.org/browse/ARM-15 LP:1068595 - Enabling function tracer kills the system on TC2 
* "ARM-17":http://cards.linaro.org/browse/ARM-17 LP:1110634 - BLS-460: Perf group counting requires 'cpu_cycles' event as the first event in the event list specified to the perf tool.
* "ARM-18":http://cards.linaro.org/browse/ARM-18 LP:1131208 - arm64: create config fragments and work with other teams to use them
* "ARM-21":http://cards.linaro.org/browse/ARM-21 LP:1180778 - vexpress: A9: Reboot fails with lockup or crashes
* "ARM-28":http://cards.linaro.org/browse/ARM-28 Kernel crashes observed with 13.05 LEB release candidate
* "ARM-33":http://cards.linaro.org/browse/ARM-33 CPU PMUs broken by IKS topic branch
* "LP: #1183781":https://launchpad.net/bugs/1183781 Enabling IKS after boot crashes Android
...
h3. Known Issues that are "Won't Fix" by ARMLT
