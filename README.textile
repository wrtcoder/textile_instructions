...
* "LP: #1161037":https://launchpad.net/bugs/1161037 drivers/video/amba_clcld.c does not link properly as a module

h3. Ubuntu bugs:

* "LP: #1159937":https://launchpad.net/bugs/1159937 TC2: Ubuntu: Incorrect cpufreq governors when booted on A7 CPU
* "LP: #1058013":https://launchpad.net/bugs/1058013 "device-tree" test failed on vexpress A9 ubuntu.
...
* "LP: #1171780":https://launchpad.net/bugs/1171780 UEFI: vexpress A9 default config should use Device Tree
