h1. Versatile Express 13.08 Release
...
| "HMP: select 'best' task for migration rather than 'current'":https://git.linaro.org/gitweb?p=kernel/linux-linaro-stable.git;a=commit;h=ee52487aaf659ef630ce3371de0e59944253581b | <p style="color:white;background-color:green">New in 13.08</p> |
| "sched: HMP fix traversing the rb-tree from the curr pointer":https://git.linaro.org/gitweb?p=kernel/linux-linaro-stable.git;a=commit;h=aaba2453951b3743d003be228102e1da63c75326 | <p style="color:white;background-color:green">New in 13.08</p> |
| "sched: track per-rq 'last migration time'":https://git.linaro.org/gitweb?p=kernel/linux-linaro-stable.git;a=commit;h=5fad81c7739db3a1fc6380dcc3d7902666ed5ee8 | <p style="color:white;background-color:green">New in 13.08</p> |
| "HMP: Modify the runqueue stats to add a new child stat":https://git.linaro.org/gitweb?p=kernel/linux-linaro-stable.git;a=commit;h=b98cd6acc86f2c3bc10902476836746727b73ba9 | <p style="color:white;background-color:green">New in 13.08</p> |
| "HMP: Explicitly implement all-load-is-max-load policy for HMP targets":https://git.linaro.org/gitweb?p=kernel/linux-linaro-stable.git;a=commit;h=6b695bd8a4e2c86cc466010517c0260dc3653742 | <p style="color:white;background-color:green">New in 13.08</p> |
| "sched: HMP change nr_running offload metric":https://git.linaro.org/gitweb?p=kernel/linux-linaro-stable.git;a=commit;h=1f435579ea80d4639061435d8337df5a2c92e530 | <p style="color:white;background-color:green">New in 13.08</p> |
| "HMP: Implement idle pull for HMP":https://git.linaro.org/gitweb?p=kernel/linux-linaro-stable.git;a=commit;h=db20b7088c6d7f7920dace95c7fc8d9955650214 | <p style="color:white;background-color:green">New in 13.08</p> |
| "HMP: Access runqueue task clocks directly.":https://git.linaro.org/gitweb?p=kernel/linux-linaro-stable.git;a=commit;h=de66e01565848d0236ca9e7e9e2f6ecd5c27a021 | <p style="color:white;background-color:green">New in 13.08</p> |
| "HMP: Update migration timer when we fork-migrate":https://git.linaro.org/gitweb?p=kernel/linux-linaro-stable.git;a=commit;h=18e3c3d2cc1346cb7cc2e3fd777b2c6f4fbb6135 | <p style="color:white;background-color:green">New in 13.08</p> |
...
* "ARM-48":http://cards.linaro.org/browse/ARM-48 Device Tree is unavailable on ARM Versatile Express A9 Android
