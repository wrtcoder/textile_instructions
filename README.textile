...
* "LP: #1042755":https://launchpad.net/bugs/1042755 powertop doesn't show correct frequency stats
...
* "LP: #966411":https://launchpad.net/bugs/966411 vexpress-a9: ubuntu: Network manager doesn't manage ethernet connection
* "LP: #966406":https://launchpad.net/bugs/966406 vexpress-a9: ubuntu: Booting without an ethernet connection hangs
* "LP: #966377":https://launchpad.net/bugs/966377 vexpress-a9: ubuntu: Suspend-Resume doesn't work
* "LP: #966373":https://launchpad.net/bugs/966373 vexpress-a9: ubuntu: Reboot and shutdown don't work
...
* "LP: #908082":https://launchpad.net/bugs/908082 vexpress-a9: Video playback fails in Gallery app
* "LP: #906363":https://launchpad.net/bugs/906363 vexpress-a9: ICS: No thumbnails in gallery application
* "LP: #906344":https://launchpad.net/bugs/906344 vexpress-a9: ICS: Suspend-Resume doesn't work
...
* "LP: #893175":https://launchpad.net/bugs/893175 vexpress-a9: ADB over USB doesn't work
* "LP: #893127":https://launchpad.net/bugs/893127 vexpress-a9: No sound in Android
* "LP: #890601":https://launchpad.net/bugs/890601 Missing GL ES 2.0 drivers, unable to run GLMark2 benchmark
* "LP: #873283":https://launchpad.net/bugs/873283 Snowball: Taking device screenshot using ddms tool fails
