...
wget https://releases.linaro.org/13.06/ubuntu/vexpress/linaro-raring-developer-20130625-412.tar.gz

Now you need to create the image using the following commands.

bc. linaro-media-create --image-file linaro.img --image-size 2000M --dev vexpress --hwpack hwpack_linaro-vexpress_20130625-379_armhf_supported.tar.gz --binary linaro-raring-developer-20130625-412.tar.gz
