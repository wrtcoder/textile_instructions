...
We use a "Nano":http://releases.linaro.org/13.08/ubuntu/raring-images RootFS for this example, however, you could use other RootFS types such as ALIP or Developer so long as you can install it to a 2GB file (Ubuntu Desktop doesn't fit the 2GB limit).
...
wget https://releases.linaro.org/13.08/ubuntu/vexpress/linaro-raring-developer-20130826-474.tar.gz
