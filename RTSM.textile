...
wget https://releases.linaro.org/13.09/openembedded/vexpress-lsk/linaro-image-alip-genericarmv7a-20130925-103.rootfs.tar.gz

Now you need to create the image using the following commands.

bc. linaro-media-create --image-file linaro.img --image-size 2000M --dev vexpress --hwpack hwpack_linaro-lsk-vexpress_20130922-471_armhf_supported.tar.gz --binary linaro-image-alip-genericarmv7a-20130925-103.rootfs.tar.gz
