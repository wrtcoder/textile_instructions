...
We use a "Nano":http://releases.linaro.org/13.03/ubuntu/precise-images RootFS for this example, however, you could use other RootFS types such as ALIP or Developer so long as you can install it to a 2GB file (Ubuntu Desktop doesn't fit the 2GB limit).
...
bc. linaro-media-create --image-file linaro.img --image-size 2000M --dev vexpress --hwpack hwpack_linaro-vexpress_20130324-276_armhf_supported.tar.gz --binary linaro-quantal-developer-20133224-313.tar.gz
